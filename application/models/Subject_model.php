...
class Subject_model extends CI_Model{
   ...
   public function get_school_standard($school_id){
     ...
     public function get_school_subject($school_id){
        $q = $this->db->query("select * from subject where school_id=".$school_id); 
       return $q->result();
    }
    
      public function get_result_by_standard($subject_id,$school_id){ 
         ...
         where subject.subject_id=".$subject_id." and   quiz_result.quiz_school_id=".$school_id); 
