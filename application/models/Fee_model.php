...
class Fee_model extends CI_Model{
    ...
    public function get_fee_type($shool_id){

            $q = $this->db->query("select fee_types.*,standard.standard_title from fee_types 

            inner join standard on standard.standard_id = fee_types.standard_id where fee_types.school_id=".$shool_id);
    ...
    public function get_student_by_standard($standard_id){
      ...
      public function get_fees_type_by_standard($fee_types,$school_id){

         $q = $this->db->query("select * from fee_types where standard_id = '".$fee_types."' and school_id=".$school_id);
    ...
    public function get_fees_remaining_amount($fees_id,$sudent_id, $school_id){
         ...
         where fee_types.id = '".$fees_id."' and fee_types.school_id=".$school_id);
    ...
    public function get_student_fees($school_id){
        ...
        $q = $this->db->query("select student_fees.*,standard.standard_title,student_detail.student_user_name,fee_types.title  from student_fees
         ...
         where student_fees.school_id=".$school_id);
    ...
    public function get_student_fees_list($student_id, $school_id){ 
        ...
        where student_fees.student_id = '".$student_id."' and student_fees.school_id=".$school_id); 
