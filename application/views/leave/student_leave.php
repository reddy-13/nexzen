                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <form method="post">
                                                    ...
                                                    <td><?php echo $students->from_date;?></td>
                                                    <td><?php echo $students->to_date; ?></td>
                                                    
                                                   
                                                    <td><input class='tgl tgl-ios tgl_checkbox'
                                                            data-table="student_detail" data-status="student_status"
                                                            data-idfield="student_id"
                                                            data-id="<?php echo $students->id; ?>"
                                                            id='cb_<?php echo $students->id; ?>' type='checkbox'
                                                            <?php echo ($students->status == 1) ? "checked" : ""; ?> />
                                                        <label class='tgl-btn'
                                                            for='cb_<?php echo $students->id; ?>'></label>
                                                    </td>
                                                    <td>

                                                        <a href="<?php echo site_url("student/edit_leave/" . $students->id); ?>"
                                                            class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo site_url("student/delete_leave/" . $students->id); ?>"
