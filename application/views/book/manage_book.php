    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Homework
            <small>Manage Homework</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Homework</a></li>
            <li class="active">Manage Homework</li>
          </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                           <p><strong>Add Homework (Ex. English, Maths, etc)</strong></p>
                        </div>
                        <div class="box-body">
                            ...
                            echo $error;
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    <!--</div>-->
                                    <div class="col-md-4">
                                        <label for="book_description">Home Description <span class="red">*</span></label>
