                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header">
                                    <p><strong>Add Books (Ex. English, Maths, etc)</strong></p>
                                </div>
                                <div class="box-body">
                                    ...
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="box">
                                                    <div class="box-header">
                                                        <p><strong>List Homeworks (Ex. English, Maths, etc)</strong></p>
                                                    </div>
                                                    <div class="box-header">
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if ($booklist->book_thumb != "") {
                                                                          $img = $this->config->item('base_url') . "uploads/books_thum/" . $booklist->book_thumb;
                                                                      ?><img src="<?php echo $img; ?>" style="height: 80px; width: 80px;" /></td>
                                                                  <?php } ?>
                                                                  <td style="width: 15px;"><?php echo $booklist->book_file; ?></td>
                                                                  <td>
                                                                    <a href="<?php echo site_url("BookSection/edit_book/" . $booklist->book_id); ?>"
                                                                        class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                                        <a href="<?php echo site_url("BookSection/delete_book/" . $booklist->book_id); ?>"
