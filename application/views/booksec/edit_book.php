    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo site_url("BookSection/manage_book"); ?>"
                            class="btn btn-primary pull-right">Books List</a>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                <div class="box">
                                    <div class="box-header">
                                        <p><strong>Edit Books (Ex. Java, Maths, etc)</strong></p>
                                    </div>
                                        ...
                                        <form role="form" action="" method="post" enctype="multipart/form-data">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <label for="standard">Standard <span
                                                                ...
                                                                id="standard" style="width: 100%;">
                                                                <?php foreach ($school_standard as $standard) {
                                                                  ?>
                                                                  <option value="<?php echo $standard->standard_id; ?>" <?php if ($standard->standard_id == $books->book_standard) {
                                                                    echo "selected";
                                                                } ?>>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="book_title">Book Title <span
                                                            class="red">*</span></label>
                                                            <input type="text" class="form-control" id="book_title"
                                                            name="book_title"
                                                            value="<?php echo $books->book_title; ?>" />
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label for="book_author">Book Author <span
                                                                class="red">*</span></label>
                                                                <input type="text" class="form-control" id="book_author"
                                                                name="book_author" value="<?php echo $books->book_author;
                                                            ?>" />
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label for="book_description">Book Description <span
                                                                class="red">*</span></label>
                                                                <textarea rows="5" id="book_description" name="book_description"
                                                                class="form-control"> <?php echo $books->book_description; ?> </textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="thumbnail">ThumbNail Image <span
                                                                        class="red">*</span></label>
                                                                        <input type="file" class="form-control" id="thumbnail"
                                                                        name="thumbnail" /> (File should be Image Only)
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <?php
                                                                        if ($books->book_thumb != "") {
                                                                            $img = $this->config->item('base_url') . "uploads/books_thum/" . $books->book_thumb;
                                                                        ?><img src="<?php echo $img; ?>" style="height: 80px; width: 80px;" />
                                                                        </div> <?php } ?>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="uploadfile">Select PDF Book File <span
                                                                                class="red">*</span></label>
                                                                                <input type="file" class="form-control" id="uploadfile"
                                                                                name="uploadfile" /> (File should be PDF Only)

                                                                            </div>
                                                                            <div class="form-group">
                                                                                <?php echo $books->book_file; ?>
                                                                            </div>
                                                                        </div>
