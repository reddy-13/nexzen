                    ...
                    <div class="col-md-12">
                        ...
                        echo $error;
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="event_title">Event Title <span
                                                                class="red">*</span></label>
                                                        <input type="text" class="form-control" id="event_title"
                                                            name="event_title"
                                                            placeholder="Ex. Annual Function, Sport Day, Seminar, etc" />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="event_description">Event Description <span
                                                                class="red">*</span></label>
                                                        <textarea rows="5" id="event_description"
                                                            name="event_description" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="date" class="form-control" id="end_date"
                                                                    name="end_date" placeholder="Show Date"
                                                                    data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                                            </div>
                                                        </div>
                                                    </div>
                      ...
                      ?>
                            ...
                            ?><img src="<?php echo $img; ?>" style="height: 100px; width: 100px;" /></td>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url("event/edit_event/" . $eventdlist->event_id); ?>"
                                                        class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                    <a href="<?php echo site_url("event/delete_event/" . $eventdlist->event_id); ?>"
