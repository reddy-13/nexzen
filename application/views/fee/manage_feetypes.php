                    ...
                    <div class="col-md-12">
                      ...
                      ?>
                        ...
                        echo $error;
                              ...
                              ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="fee_title">Fees Title <span
                                                                class="red">*</span></label>
                                                        <input type="text" class="form-control" id="fee_title"
                                                            name="fee_title" placeholder="Ex. Education Fee, etc" />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="fee_year">Fees Year <span
                                                                class="red">*</span></label>
                                                        <input type="text" class="form-control" id="fee_year"
                                                            name="fee_year" placeholder="Ex. 2016-17" />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="payment_date">Payment Date <span
                                                                class="red">*</span></label>
                                                        <input type="date" class="form-control" id="payment_date"
                                                            name="payment_date" placeholder="Ex. 04-12-2022" />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="fee_amount">Fees Amount <span
                                                                class="red">*</span></label>
                                                        <input type="text" class="form-control" id="fee_amount"
                                                            name="fee_amount" placeholder="Ex. 5000" />
                                                    </div>
                      ...
                      ?>
                                            <tr>
                                                ...
                                                <td><?php echo $feetypelist->standard_title; ?></td>
                                                <td><?php echo substr($feetypelist->title, 0, 100); ?></td>
                                                <td><?php echo $feetypelist->year; ?></td>
                                                <td><?php echo $feetypelist->payment_date; ?></td>
                                                <td><?php echo $feetypelist->base_amount; ?></td>
                                                <td>
                                                    <a href="<?php echo site_url("fee/edit_fee/" . $feetypelist->id); ?>"
                                                        class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                    <a href="<?php echo site_url("fee/delete_fee/" . $feetypelist->id); ?>"
