                 ...
                 <select class="form-control select2" name="standard" id="standard" style="width: 100%;">
                  ...
                  <div class="col-md-3">
                     <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="attendencedate" name="attendencedate" placeholder="Show Date" value="<?php  if(isset($_POST["attendencedate"])) echo $_POST["attendencedate"]; ?>" >
                                  </div>
                                </div>
                </div>
                    ...
                    <?php  foreach($student as $students){
                       ...
                       <td><?php echo $students->student_roll_no; ?></td>
                        ...
                        <td style="color: green;">
                          <input type="radio" checked="checked" name="attendence<?php echo $students->student_id ?>" value="1"  <?php if(isset($array['attended']) && $array['attended'] == "1") {echo "checked";} ?>/>Presend </td>

                        <td style="color: red;"><input type="radio"   name="attendence<?php echo $students->student_id ?>" value="0" <?php 
                        if(isset($array['attended']) && $array['attended'] == "0") {echo "checked";} ?>/>Absent </td>
