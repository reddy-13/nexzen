...
<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="box-body">
                                ...
                                <div id="external-events">
                                    ...
                                    <div class="external-event bg-light-blue">
                                        <?php echo $holiday->holiday_title . "(" . $holiday->holiday_date . ")"; ?>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div><!-- /.box-body -->
                    ...
                    echo $error;
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="start_date" name="start_date"
                                            placeholder="Show Date" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                                    </div><!-- /input-group -->
                                    <div class="input-group">
                                        <input id="holiday_title" type="text" class="form-control" name="holiday_title"
                                            placeholder="Holiday Title" />
                                        <div class="input-group-btn">
                                            <input id="" type="submit" class="btn btn-primary btn-flat"
                                                name="addholiday" value="Add" />
                                        </div><!-- /btn-group -->
                                    </div><!-- /input-group -->
                                </form>
                            </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
    <script
        src="<?php echo base_url($this->config->item("theme_admin") . "/plugins/fullcalendar/fullcalendar.min.js"); ?>">
    </script>
