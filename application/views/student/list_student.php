                    ...
                    <div class="col-md-12">
                      ...
                      ?>
                        ...
                        "></td>
                                                    ...
                                                    <td><?php echo $students->punch_card_id; ?></td>
                                                    ...
                                                    <td><input class='tgl tgl-ios tgl_checkbox'
                                                            ...
                                                            data-id="<?php echo $students->student_id; ?>"
                                                            id='cb_<?php echo $students->student_id; ?>' type='checkbox'
                                                            <?php echo ($students->student_status == 1) ? "checked" : ""; ?> />
                                                        <label class='tgl-btn'
                                                            for='cb_<?php echo $students->student_id; ?>'></label>
                                                    </td>
                                                    <td>

                                                        <a href="<?php echo site_url("student/edit_student/" . $students->student_id); ?>"
                                                            class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo site_url("student/delete_student/" . $students->student_id); ?>"
