                        ...
                        <div class="box-body">
                            ...
                            echo $error;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label for="punch_card_id">Student Card Id <span class="red">*</span></label>
                                        <input type="text" class="form-control" id="punch_card_id" name="punch_card_id" value="<?php echo $student->punch_card_id; ?>"/>
                                    </div>
                                     <div class="col-md-6">
