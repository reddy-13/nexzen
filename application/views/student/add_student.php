                        ...
                        $student_unique_no =  uniqid($today.'_');
                         ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                          <div class="form-group">
                                        <label for="punch_card_id">Student Card ID   &nbsp;&nbsp; <small>eg. 00000001</small> <span class="red">*</span> <span id="card_msg"></span></label>
                                        <?php 
                                          ...
                                          $school_data = $this->school_model->get_school_profile();
                                            ...
                                            // print_r($school_data);
                                         ?>
                                        <input type="hidden" id="school_id" name="school_id" value="<?php echo $school_data->school_id; ?>">
                                        <input type="text" class="form-control" id="punch_card_id" name="punch_card_id" value="<?php if(isset($_REQUEST["punch_card_id"])){echo $_REQUEST["punch_card_id"]; } ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="student_photo">Student Photo <span id="img-msg"></span> </label>
                                        <input type="file" class="form-control" id="student_photo" onchange="validateImage()" name="student_photo" />
                                        </div>
                                    </div>
    ...
    // card id and machinne id checking...
      ...
      if(regexp.test($('#punch_card_id').val())){
        ...
        $.ajax({
                ...
                method:'POST',
                data: {punch_card_id:punch_card_id,school_id:school_id},
                beforeSend: function () {
                  $('#e_loader').show();
                },
                success:function(res) {
