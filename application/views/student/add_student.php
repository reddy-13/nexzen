                         ...
                         ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="student_birthdate" name="student_birthdate" placeholder="Show Date" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask value="<?php if(isset($_REQUEST["student_birthdate"])){echo $_REQUEST["student_birthdate"]; } ?>">
                                    </div>
                                     <div class="col-md-6">
                                    ...
                                    <!-- <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <label for="student_photo">Student Photo <span class="red">*</span> </label>
