         ...
         <?php if($teacher_data): ?>
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  ...
                  // $teacher_data = $this->school_model->get_school_profile();
                    ...
                    if($teacher_data){
                      $q = $this->db->query("select * from event where school_id='".$teacher_data->school_id."'");
                                    $event =  $q->result();
                                    echo count($event);
                    }else{
                      echo 0;
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  ...
                  <?php 
                  if($teacher_data){
                    $q = $this->db->query("select * from student_detail where school_id='".$teacher_data->school_id."'");
                                    $student =  $q->result();
                                    echo count($student);
                                  }else{
                                    echo 0;
             ...
             <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  ...
                  <?php 
                   if($teacher_data){
                    $q = $this->db->query("select * from teacher_detail where school_id='".$teacher_data->school_id."'");
                                    $student =  $q->result();
                                    echo count($student);
                                  }else{
                                    echo 0;
             ...
             <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  ...
                  <?php 
                  if($teacher_data){
                    $q = $this->db->query("select * from exam where school_id='".$teacher_data->school_id."'");
                                    $student =  $q->result();
                                    echo count($student);
                                  }else{
                                    echo 0;
          ...
          <div class="row">
            ...
            <div class="col-md-3">
             ...
             <div class="panel panel-default">
                                 ...
                                 <?php
                                       $q = $this->db->query("select * from holiday where school_id=".$teacher_data->school_id." order by holiday_date desc limit 5");
                                $up_holiday = $q->result();
          ...
          <div class="col-md-4">
             ...
             <div class="panel panel-default">
                                 ...
                                 $today = date('Y-m-d');
                                       $q = $this->db->query("select * from event where event_start='".$today."' and school_id='".$teacher_data->school_id."'");
                                $up_holiday = $q->result();
                                if($up_holiday!=""){
                                        foreach($up_holiday as $holiday){ ?>
          ...
          <?php else: ?>
            <div class="well">
              <h1 class="text-warning text-center">Please update your school profile</h1>
