                    ...
                    <div class="col-md-12">
                        ...
                        echo $error;
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="exam_title">Exam Title <span
                                                                class="red">*</span></label>
                                                        <input type="text" class="form-control" id="exam_title"
                                                            name="exam_title"
                                                            placeholder="Ex. Monthaly Test, Gujarati Test, etc" />
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label for="exam_description">Exam Note or Description <span
                                                                class="red">*</span></label>
                                                        <textarea rows="5" id="exam_description" name="exam_description"
                                                            class="form-control" placeholder="Exam Detail"></textarea>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="start_date">Exam Date <span
                                                                    class="red">*</span></label>
                                                            <div class="input-group">

                                                                <input type="date" class="form-control" id="start_date"
                                                                    name="start_date" placeholder="Show Date"
                      ...
                      ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo site_url("examresult/manage_result/" . $examlist->exam_id); ?>"
                                                        class="btn btn-primary"><i class="fa fa-plus"></i> Add
                                                        Result</a></td>
                                                <td>
                                                    <a href="<?php echo site_url("exam/edit_exam/" . $examlist->exam_id); ?>"
                                                        class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                    <a href="<?php echo site_url("exam/delete_exam/" . $examlist->exam_id); ?>"
