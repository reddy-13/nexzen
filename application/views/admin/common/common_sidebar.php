<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="#">
                    <i class="fa fa-user"></i> <span>User Management</span> <small
                        class="label pull-right bg-green"></small>
                </a>
            ...
            <li>
                <a href="#">
                    <i class="fa fa-graduation-cap"></i> <span>Teacher Management</span> <small
                        class="label pull-right bg-green"></small>
                </a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo site_url("teacher/add_teacher"); ?>"><i class="fa fa-plus"></i>Add
                            Teacher</a></li>
                    <li><a href="<?php echo site_url("teacher/list_teacher"); ?>"><i class="fa fa-list"></i>List
                            Teacher</a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a href="#">
                    <i class="fa fa-money"></i> <span>Fees Management</span> <small
                        class="label pull-right bg-green"></small>
                </a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo site_url("fee/manage_feetypes"); ?>"><i class="fa fa-plus"></i>Manage Fees
                            Types</a></li>
