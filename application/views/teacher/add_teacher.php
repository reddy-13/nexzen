                          ...
                          <div class="row">
                          	<div class="form-group">
                                ...
                                <div class="form-group">
                          			...
                          			<label for="teacher_name">Username <span class="red">*</span></label>
                                ...
                                <div class="form-group">
                                   ...
                                   <h4 class="box-title">General Information</h4>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="teacher_email">Teacher Email  <smapn id="email_msg"></smapn> </label>
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="teacher_photo">Teacher Photo  <span id="img-msg"></span></label>
                                        <input type="file" class="form-control" onchange="validateImage()" id="teacher_photo" name="teacher_photo" />
                                      </div>
                                    </div>
