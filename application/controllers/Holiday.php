    ...
    public function manage_holiday(){
        if(_is_user_login($this)){
          ...
          if(_get_current_user_type_id($this) == 1){
            ...
            if(isset($_REQUEST["addholiday"])){
              ...
              $date = $this->input->post('start_date');
                ...
                else
                {
                      ...
                      $q = $this->db->query("select * from holiday where holiday_date='".$date."' and school_id='".$school_data->school_id."'");
                ...
                else
                {
                           ...
                           $start_date = $this->input->post("start_date");
                            ...
                            array("holiday_title"=>$holiday_title, "school_id"=>$school_data->school_id, 
            ...
            $data["up_holiday"] = $this->holiday_model->get_school_upcomming_holiday($school_data->school_id);
            
            $data['holiday_json'] = $this->holiday_model->get_school_holiday_calender($school_data->school_id);
 	...
 	public function list_holiday()
	{
		if(_is_user_login($this)){
          if(_get_current_user_type_id($this) == 1){
            ...
            $data = array();
            $this->load->model("holiday_model");
            $data["holiday"] = $this->holiday_model->get_school_holiday($school_data->school_id);
