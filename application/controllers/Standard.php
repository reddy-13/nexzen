  ...
  public function manage_standard()
  {
    if (_is_user_login($this)) {
      ...
      if (_get_current_user_type_id($this) == 1) {
        $data["standard"] = $this->standard_model->get_school_standard($school_data->school_id);
        ...
        $data["standard"] = $this->standard_model->get_school_standard($teacher_data->school_id);
        # code...
      }
      ...
      if ($_POST) {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          $q = $this->db->query("select * from standard where school_id=" . $school_id . " AND standard_title='" . $this->input->post('standard_title') . "'");
          ...
          if (isset($duplicate_check)) {
            ...
            $this->common_model->data_insert(
              "standard",
              array("standard_title" => $standard_title, "school_id" => $school_id)
            );
