...
class Subject extends CI_Controller {
    ...
    public function manage_subject(){
        if(_is_user_login($this)){
            ...
            $data["subject"] = $this->subject_model->get_school_subject($school_data->school_id);
          
          $this->load->model("subject_model");
          $data["school_standard"] = $this->subject_model->get_school_standard($school_data->school_id);
            if($_POST){
               ...
               $this->form_validation->set_rules('subject_total_ques', 'Subject Total Question', 'trim|required');
        		...
        		}else
                {
                           ...
                           $quiz_time = $this->input->post("quiz_time");
                            ...
                            array("subject_title"=>$subject_title, "school_id"=>$school_data->school_id,  
               ...
               $this->form_validation->set_rules('subject_total_ques', 'Subject Total Question', 'trim|required');
                ...
                if ($this->form_validation->run() == FALSE) 
        		{
        			...
        			$data["error"] = '<div class="alert alert-warning alert-dismissible" role="alert">
                        ...
                        $update_array = array("subject_title"=>$subject_title, "school_id"=>$school_data->school_id,
                        "quiz_time"=>$quiz_time, "subject_total_ques"=>$subject_total_ques,"subject_standard"=>$standard);
